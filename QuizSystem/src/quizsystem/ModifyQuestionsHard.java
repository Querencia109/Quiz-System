...
public class ModifyQuestionsHard extends javax.swing.JFrame {
    ...
    public ModifyQuestionsHard() {
        initComponents();
        updateTable();
    }
    
    public ModifyQuestionsHard(String username) {
        initComponents();
        updateTable();
    ...
    public void setUpdate() {
        action2 = "Modified Hard Question";
    ...
    private void modifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyActionPerformed
        ...
        if (modtable.getSelectedRowCount() == 1) {
            ...
            try {
                String check = "SELECT * FROM tbl_hard WHERE question = '"+quest2+"'";
            ...
            try {
                conn = DriverManager.getConnection(CONN_STRING, USERNAME, PASSWORD);
                String sql = "UPDATE tbl_hard SET question = '"+quest2+"', choice1 = '"+c12+"', choice2 = '"+c22+"', choice3 = '"+c32+"', choice4 = '"+c42+"', answer = '"+answer2+"', points = '"+points+"' WHERE questionnum = '"+adn+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyQuestionsHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifyQuestionsHard().setVisible(true);
            }
        });
    }
