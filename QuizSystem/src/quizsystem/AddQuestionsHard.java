...
public class AddQuestionsHard extends javax.swing.JFrame {
    ...
    public AddQuestionsHard() {
        initComponents();
        updateTable();
        setQuestionNumber();
    }
    
    public AddQuestionsHard(String username) {
        initComponents();
        updateTable();
        setQuestionNumber();
    ...
    public void setQuestionNumber() {
        try {
            ...
            String sqes = "SELECT COUNT(*) FROM tbl_hard";
            Statement ses = conn.prepareStatement(sqes);
            ResultSet rses = ses.executeQuery(sqes);
            rses.next();
            hSize = 1 + rses.getInt(1);
        } catch (SQLException e) {
            System.out.println("Failed To Connect");
        }
        adnum.setText(String.valueOf(hSize));
    }
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        if(adn.equals("") || adq.equals("") || adch1.equals("") || adch2.equals("") || adch3.equals("") || adch4.equals("") || aass.equals("")) {
            ...
            try {
            String check = "SELECT * FROM tbl_hard WHERE question = '"+adq2+"'";
            ...
            if (rs.next()) {
                ...
                if (adch12.equals(adch22) || adch12.equals(adch32) || adch12.equals(adch42)) { // 1st Choice
                    ...
                    try {
                        conn = DriverManager.getConnection(CONN_STRING, USERNAME, PASSWORD);
                        String sql = "INSERT INTO tbl_hard VALUES ('"+adn+"', '"+adq2+"', '"+adch12+"', '"+adch22+"', '"+adch32+"', '"+adch42+"', '"+aass2+"', '"+points+"')";
                        PreparedStatement pst = conn.prepareStatement(sql);
                        pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddQuestionsHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddQuestionsHard().setVisible(true);
            }
        });
    }
