...
public class ModifyQuestionsEasy extends javax.swing.JFrame {
    ...
    public ModifyQuestionsEasy() {
        initComponents();
        updateTable();
    }
    
    public ModifyQuestionsEasy(String username) {
        initComponents();
        updateTable();
    ...
    public void setUpdate() {
        action2 = "Modified Easy Question";
    ...
    private void modifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyActionPerformed
        ...
        if (modtable.getSelectedRowCount() == 1) {
            ...
            try {
                conn = DriverManager.getConnection(CONN_STRING, USERNAME, PASSWORD);
                String sql = "UPDATE tbl_easy SET question = '"+quest2+"', choice1 = '"+c12+"', choice2 = '"+c22+"', choice3 = '"+c32+"', choice4 = '"+c42+"', answer = '"+answer2+"', points = '"+points+"' WHERE questionnum = '"+adn+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyQuestionsEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifyQuestionsEasy().setVisible(true);
            }
        });
    }
