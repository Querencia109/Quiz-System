...
public class AdminIntermediate extends javax.swing.JFrame {
    ...
    public AdminIntermediate() {
        initComponents();
        updateTable();
    }

    public AdminIntermediate(String username) {
        initComponents();
        updateTable();
    ...
    public void setUpdate() {
        action2 = "Removed Intermediate Question";
    ...
    private void addquestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addquestionActionPerformed
        new AddQuestionsIntermediate(username).setVisible(true);
        this.dispose();
    ...
    private void modifyquestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyquestionActionPerformed
        new ModifyQuestionsIntermediate(username).setVisible(true);
        this.dispose();
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        ...
        if(aetable.getSelectedRowCount()==1) {
            ...
            try {
                conn = DriverManager.getConnection(CONN_STRING, USERNAME, PASSWORD);
                String sql = "DELETE from tbl_intermediate WHERE questionnum ='" + selected + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminIntermediate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminIntermediate().setVisible(true);
            }
        });
    }
