...
public class AddQuestionsEasy extends javax.swing.JFrame {
    ...
    public AddQuestionsEasy() {
        initComponents();
        updateTable();
        setQuestionNumber();
    }
    
    public AddQuestionsEasy(String username) {
        initComponents();
        updateTable();
        setQuestionNumber();
    ...
    public void setQuestionNumber() {
        try {
            ...
            rses.next();
            eSize = 2 + rses.getInt(1);
        } 
        catch (SQLException e) {
            System.out.println("Failed To Connect");
        }
        adnum.setText(String.valueOf(eSize));
    }
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        if (adn.equals("") || adq.equals("") || adch1.equals("") || adch2.equals("") || adch3.equals("") || adch4.equals("") || aass.equals("")) {
            ...
            try {
                String check = "SELECT * FROM tbl_easy WHERE question = '" + adq2 + "'";
                ...
                if (rs.next()) {
                    ...
                    if (adch12.equals(adch22) || adch12.equals(adch32) || adch12.equals(adch42)) { // 1st Choice
                        ...
                        if (action == JOptionPane.YES_OPTION) {//if the admin really wants to add an item
                            try {
                                conn = DriverManager.getConnection(CONN_STRING, USERNAME, PASSWORD);
                                String sql = "INSERT INTO tbl_easy VALUES ('" + adn + "', '" + adq2 + "', '" + adch12 + "', '" + adch22 + "', '" + adch32 + "', '" + adch42 + "', '" + aass2 + "', '" + points + "')";
                                PreparedStatement pst = conn.prepareStatement(sql);
                                pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddQuestionsEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddQuestionsEasy().setVisible(true);
            }
        });
    }
